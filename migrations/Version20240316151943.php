 ...
 */
final class Version20240316151943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT NOT NULL, user_id_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, date_added TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, likes INT DEFAULT NULL, dislikes INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE movie ADD CONSTRAINT FK_1D5EF26F9D86650F FOREIGN KEY (user_id_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP CONSTRAINT FK_1D5EF26F9D86650F');
